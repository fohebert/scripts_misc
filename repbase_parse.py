...
__authors__ = "Eric Normandeau and Nicolas Maillet, adaptation par Francois Olivier Hebert"
    ...
    for line in input_file:
        if line.startswith("Query="):
            if new_contig == True:
                res += "\n"
            blast_count = 0
            current_blast = str(re.findall(" [a-zA-Z]*.*", line)[0])
            new_contig = True
            complete = False
